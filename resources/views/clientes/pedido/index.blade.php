                                ...
                                <div>
                                    ...
                                    <div class="flex">
                                        <div class="flex w-6/12 pt-2 pb-0 pl-2 space-x-2 text-xs font-bold text-gray-500 bg-blue-100 rounded-tl-md">
                                            <div class="w-2/12 text-left md:w-1/12" >{{ __('Pedido') }}
                                                {{-- <br>{{ __('Presup.')  }} --}}
                                            </div>
                                            ...
                                            <div class="w-1/12 text-left md:w-1/12" >{{ __('Laminado') }}</div>
                                        ...
                                        <div class="w-3/12 pt-2 pb-0 space-x-2 text-xs font-bold text-gray-500 bg-blue-100 ">
                                            ...
                                            <div class="flex-none w-4/12 md:flex md:w-full">
                                                <div class="flex flex-row w-full pb-1 md:w-4/12">
                                                    ...
                                                    {{-- <input id="filtroarchivos" type="checkbox" wire:model.live="filtroarchivos" class=""/> --}}
                                                </div>
                                                @if($tipo!=1)
                                                <div class="flex flex-row w-full pb-1 md:w-4/12">
                                                    <label for="filtromaqueta">Ctr.Maqueta </label> &nbsp;
                                                    {{-- <input id="filtromaqueta" type="checkbox" wire:model.live="filtromaqueta" class=""/> --}}
                                                </div>
                                                @endif
                                                <div class="flex flex-row w-full pb-1 md:w-4/12">
                                                    <label for="filtroplotter">Ctr.Plot</label> &nbsp;
                                                    {{-- <input id="filtroplotter" type="checkbox" wire:model.live="filtroplotter" class=""/> --}}
                                                </div>
                                                <div class="flex flex-row w-full pb-1 md:w-4/12">
                                                    <label for="filtroentrega">Ctr.Ent</label> &nbsp;
                                                    {{-- <input id="filtroentrega" type="checkbox" wire:model.live="filtroentrega" class=""/> --}}
                                                </div>
                                            </div>
                                        </div>
