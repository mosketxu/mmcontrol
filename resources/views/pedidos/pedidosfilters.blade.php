<div class="flex justify-between ">
    <div class="flex w-2/12 ">
        <div class="w-full">
            ...
            <div class="flex">
                <input type="text" wire:model="search" class="w-full text-sm py-1 border border-blue-100 rounded-lg" placeholder="Búsqueda por referencia, ISBN o pedido..." autofocus/>
                @if($search!='')
