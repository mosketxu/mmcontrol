...
{{-- <div class="">
    <div class="flex justify-between mx-2 mt-2 mb-0 space-x-1">
        ...
        <div class="flex flex-row-reverse w-2/12 ">
            <div class="">
                ...
                @endif
                <x-button.button  onclick="location.href = '{{ route('producto.nuevo',$tipo ) }}'" color="orange" >{{ __('Nuevo') }}</x-button.button>
            </div>
        </div>
    </div> --}}
    ...
    <div class="">
        <div class="flex-col space-y-4 text-gray-500 border border-orange-300 rounded shadow-md">
            @if ($tipo=='1')
