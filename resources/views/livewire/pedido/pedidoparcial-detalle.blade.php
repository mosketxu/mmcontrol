<div class="py-1 space-y-4">
    ...
    <div class="flex pt-2 pb-0 pl-2 text-sm text-left text-gray-500 bg-blue-100 rounded-t-md">
        <div class="w-6/12 font-light  ">{{ __('Concepto')}} </div>
        <div class="w-2/12 text-right font-light  mr-3  ">{{ __('Cantidad')}} </div>
    </div>
    <div>
        ...
        <div class="flex w-full py-0 my-0 text-sm text-left bg-white border-t-0 border-y" wire:loading.class.delay="opacity-50">
            ...
            <div class="w-2/12  mr-3">
                <input type="text" value="{{ $detalle->cantidad }}"
                    ...
                    class="w-full text-right pr-2 mr-2 text-sm font-thin  text-gray-500 border-0 rounded-md"/>
            </div>
        ...
        <form wire:submit.prevent="save">
            <div class="flex p-1 w-full text-sm bg-blue-200 rounded-b-md" wire:loading.class.delay="opacity-50">
                <div class="w-6/12">
                ...
                <div class="w-2/12 mr-3">
                    <input type="number" step="any" wire:model.defer="cantidad"
                        class="w-full text-right text-xs  border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"/>
                </div>
                <div class="w-1/12 ">
