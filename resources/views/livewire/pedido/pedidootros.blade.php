                ...
                <form wire:submit.prevent="save" class="text-sm">
                    <div class="p-1 m-1 ">
                        <div class="flex p-1 rounded-md bg-blue-50">
                            <h3 class="pl-1 font-semibold">Datos generalesssss</h3>
                        ...
                        <div class="flex flex-col mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                            <div class="w-8/12 form-item">
                                ...
                                <textarea wire:model.defer="otros" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{$escliente}}/>>{{ old('observaciones') }} </textarea>
