            ...
            <div class="flex-col space-y-4">
                <div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center w-full space-x-1 text-sm text-gray-500 border-t-0 border-y hover:bg-gray-100" wire:loading.class.delay="opacity-50" onclick="location.href = '{{ route('presupuesto.editar',[$presupuesto,'i']) }}'">
                            <div class="flex w-9/12">
