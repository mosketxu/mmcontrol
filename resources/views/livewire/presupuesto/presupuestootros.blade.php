                        ...
                        <div class="flex flex-col mx-2 space-y-0.5 md:space-y-0 md:flex-row md:space-x-2">
                            ...
                            <div class="flex flex-col mx-2 space-y-1 md:space-y-0 md:flex-row md:space-x-2">
                                <div class="w-full form-item">
                                    ...
                                    <textarea wire:model="manipulacion" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{ $escliente }} {{$deshabilitado}}> </textarea>
                                </div>
                                <div class="w-full form-item">
                                    <x-jet::label for="transporte">{{ __('Distribución') }}</x-jet::label>
                                    <textarea wire:model="transporte" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{ $escliente }} {{$deshabilitado}}> </textarea>
                                </div>
                                <div class="w-full form-item">
                                    <x-jet::label for="especificacioneslogisticas">{{ __('Especificaciones Logísticas') }}</x-jet::label>
                                    <textarea wire:model="especificacioneslogisticas" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{ $escliente }} {{$deshabilitado}}> </textarea>
                                </div>
                            </div>
                            {{-- otros --}}
                            <div class="flex flex-col mx-2 space-y-0.5 md:space-y-0 md:flex-row md:space-x-2">
