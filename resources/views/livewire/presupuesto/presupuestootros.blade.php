                            ...
                            <div class="flex flex-col mx-2 space-y-1 md:space-y-0 md:flex-row md:space-x-2">
                                ...
                                <div class="w-full form-item">
                                    <div class="flex py-2">
                                        ...
                                        <input type="search" wire:model.live="filtroisbn" placeholder="Escribe para filtrar" class="w-full h-5 px-2 py-1 text-sm border border-blue-100 rounded-lg" />
                                        @if($filtroisbn!='')
                                ...
                                <div class="w-full form-item">
                                    <div class="flex py-2">
                                        ...
                                        <input type="search" wire:model.live="filtroreferencia" placeholder="Escribe para filtrar"  class="w-full h-5 px-2 py-1 text-sm border border-blue-100 rounded-lg" />
                                        @if($filtroreferencia!='')
                        ...
                        <div class="flex flex-col mx-2 space-y-0.5 md:space-y-0 md:flex-row md:space-x-2">
                            ...
                            <div class="flex flex-col mx-2 space-y-1 md:space-y-0 md:flex-row md:space-x-2">
                                <div class="w-full form-item">
                                    ...
                                    <textarea wire:model.live="manipulacion" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{ $escliente }} {{$deshabilitado}}> </textarea>
                                </div>
                                <div class="w-full form-item">
                                    <x-jet::label for="transporte">{{ __('Distribución') }}</x-jet::label>
                                    <textarea wire:model.live="transporte" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{ $escliente }} {{$deshabilitado}}> </textarea>
                                </div>
                                <div class="w-full form-item">
                                    <x-jet::label for="especificacioneslogisticas">{{ __('Especificaciones Logísticas') }}</x-jet::label>
                                    <textarea wire:model.live="especificacioneslogisticas" class="w-full text-xs border-gray-300 rounded-md" rows="1" {{ $escliente }} {{$deshabilitado}}> </textarea>
                                </div>
                            </div>
                            {{-- otros --}}
                            <div class="flex flex-col mx-2 space-y-0.5 md:space-y-0 md:flex-row md:space-x-2">
