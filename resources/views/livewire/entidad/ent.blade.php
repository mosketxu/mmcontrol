    ...
    <div class="flex-col space-y-4 text-gray-500">
        <form wire:submit.prevent="save" class="">
            <div class="px-2 mx-2 my-1 rounded-md bg-blue-50">
                ...
                <x-jet::input  wire:model="entidad.id" type="hidden"/>
                <hr>
            </div>
            <div class="flex flex-col pl-2 mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="w-full form-item">
                    ...
                    <x-jet::input wire:model="entidad.entidad" type="text" class="w-full " id="entidad" name="entidad" :value="old('entidad') "/>
                    <x-jet::input-error for="entidad" class="mt-2" />
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="nif">{{ __('Nif') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.nif" type="text" id="nif" name="nif" :value="old('nif')" class="w-full"/>
                    <x-jet::input-error for="nif" class="mt-2" />
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="responsable">{{ __('Responsable') }}</x-jet::label>
                    <x-select wire:model="entidad.responsable" selectname="responsable" class="w-full">
                ...
                <div class="w-4/12 form-item">
                    ...
                    <x-jet::input wire:model="fechaIni" type="date" id="fechaIni" name="fechaIni" class="w-full"/>
            ...
            <div class="flex flex-col pl-2 mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="w-full form-item">
                    ...
                    <x-jet::input  wire:model="entidad.emailgral" type="text" id="emailgral" name="emailgral" :value="old('emailgral')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="emailadm">{{ __('Email Adm') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.emailadm" type="text" id="emailadm" name="emailadm" :value="old('emailadm')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="emailadm">{{ __('Email Aux') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.emailaux" type="text" id="emailaux" name="emailaux" :value="old('emailaux')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="web">{{ __('Web') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.web" type="text" id="web" name="web" :value="old('web')" class="w-full"/>
                </div>
            </div>
            <div class="flex flex-col pl-2 mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="w-5/12 form-item">
                    <x-jet::label for="tfno">{{ __('Tfno.') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.tfno" type="text" id="tfno" name="tfno" :value="old('tfno')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="direccion">{{ __('Dirección') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.direccion" type="text" id="direccion" name="direccion" :value="old('direccion')" class="w-full"/>
                </div>
                <div class="w-2/12 form-item">
                    <x-jet::label for="cp">{{ __('C.P.') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.cp" type="text" id="cp" name="cp" :value="old('cp')" class="w-full"/>
                </div>
                <div class="w-4/12 form-item">
                    <x-jet::label for="localidad">{{ __('Localidad') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.localidad" type="text" id="localidad" name="localidad" :value="old('localidad')" class="w-full"/>
                </div>
                <div class="w-4/12 form-item">
                    <x-jet::label for="provincia">{{ __('Provincia') }}</x-jet::label>
                    <x-select wire:model="entidad.provincia_id" selectname="provincia_id" class="w-full">
                ...
                <div class="w-3/12 form-item">
                    ...
                    <x-select wire:model="entidad.pais_id" selectname="pais_id" class="w-full">
                        <option value="">-- choose --</option>
            ...
            <div class="flex flex-col pl-2 mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                {{-- <div class="w-full form-item">
                    ...
                    <x-jet::input  wire:model="entidad.banco1" type="text" id="banco1" name="banco1" :value="old('banco1')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="iban1" >{{ __('Iban 1') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.iban1" type="text" id="iban1" name="iban1" :value="old('iban1')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="banco2"  title="Banco a la que el cliente hará la transferencia">{{ __('Transferencia a:') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.banco2" type="text" id="banco2" name="banco2" :value="old('banco2')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="iban2" title="Cuenta a la que el cliente hará la transferencia">{{ __('Iban Transferencia 2') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.iban2" type="text" id="iban2" name="iban2" :value="old('iban2')" class="w-full"/>
                </div> --}}
                {{-- <div class="w-full form-item">
                    <x-jet::label for="metodopago_id">{{ __('Método Pago') }}</x-jet::label>
                    <x-select wire:model="entidad.metodopago_id" class="w-full" selectname="metodopago_id">
                        <option value="">-- choose --</option>
                ...
                {{-- <div class="w-full form-item">
                    ...
                    <x-select wire:model="entidad.vencimientofechafactura" class="w-full" selectname="vencimientofechafactura">
                        <option value="">-- choose --</option>
                ...
                <div class="w-full form-item">
                    ...
                    <x-jet::input  wire:model="entidad.empresacredito" type="text" id="empresacredito" name="empresacredito" :value="old('empresacredito')" class="w-full"/>
                    <x-jet::input-error for="empresacredito" class="mt-2" />
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="importecredito" >{{ __('Importe Crédito') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.importecredito" type="number" step="any" id="importecredito" name="importecredito" :value="old('importecredito')" class="w-full"/>
                    <x-jet::input-error for="importecredito" class="mt-2" />
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="vigenciacredito" >{{ __('Vigencia Crédito') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.vigenciacredito" type="text" id="vigenciacredito" name="vigenciacredito" :value="old('vigenciacredito')" class="w-full"/>
                ...
                <div class="w-full form-item">
                    ...
                    <x-jet::input  wire:model="entidad.metodopago" type="text" id="metodopago" name="metodopago" :value="old('metodopago')" class="w-full"/>
                </div>
                <div class="w-full form-item">
                    <x-jet::label for="vencimientofechafactura"  title="Método de pago">{{ __('Fecha Vencimiento:') }}</x-jet::label>
                    <x-jet::input  wire:model="entidad.vencimientofechafactura" type="text" id="vencimientofechafactura" name="vencimientofechafactura" :value="old('vencimientofechafactura')" class="w-full"/>
                </div>
            </div>
            {{-- <div class="px-2 mx-2 my-2 rounded-md bg-blue-50">
            ...
            <div class="flex flex-col pl-2 mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <div class="w-full form-item">
                    ...
                    <textarea wire:model="entidad.observaciones" class="w-full text-sm border-gray-300 rounded-md" rows="3">{{ old('observaciones') }} </textarea>
