    ...
    <div class="p-1 mx-2 ">
        ...
        <div class="py-1 space-y-4">
            ...
            <div class="flex-col ">
                {{-- titulos --}}
                <div>
                    <div class="flex pt-2 pb-0 pl-2 space-x-1 text-sm text-left text-gray-500 bg-blue-100 rounded-t-md ">
                        @if ($campofechavisible==1)
                            <div class="flex-1 min-w-0 pl-1 font-light text-left" >{{ __($titcampofecha)}} </div>
                        @endif
                        @if ($campo1visible==1)
                            <div class="flex-1 min-w-0 pl-1 font-light text-left ">{{ __($titcampo1)}} </div>
                        @endif
                        @if ($campo2visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo2)}} </div>
                        @endif
                        @if ($campo3visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo3)}} </div>
                        @endif
                        @if ($campo4visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo4)}} </div>
                        @endif
                        @if ($campo5visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo5)}} </div>
                        @endif
                        @if ($campo6visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo6)}} </div>
                        @endif
                        @if ($campo7visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo7)}} </div>
                        @endif
                        @if ($campo8visible==1)
                            <div class="flex-1 min-w-0 font-light text-left ">{{ __($titcampo8)}} </div>
                        @endif
                        @if ($campoimgvisible==1)
                            <div class="flex-1 min-w-0 font-light text-left">{{ __($titcampoimg)}} </div>
                        @endif
                            <div class="w-10 shrink-0 font-light text-left"></div>
                    </div>
                </div>
                {{-- datos --}}
                <div>
                    ...
                    <div class="flex w-full py-0 my-0 space-x-1 text-sm text-left bg-white border-t-0 border-y" wire:loading.class.delay="opacity-50">
                        ...
                        @endif
                        <div class="flex flex-row-reverse w-10 shrink-0 pr-2 mt-2">
                            @if($editarvisible==1)
                ...
                <div>
                    <form wire:submit.prevent="save">
                        <div class="flex w-full p-2 my-0 space-x-1 text-sm text-left bg-blue-200 rounded-b-md" wire:loading.class.delay="opacity-50">
                            @if ($campofechavisible==1)
                                <div class="flex-1 min-w-0 text-left">
                            ...
                            @endif
                            <div class="w-10 shrink-0 text-left">
