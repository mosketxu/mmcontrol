                    ...
                    <div class="">
                        <div class="flex w-full pt-2 text-sm font-bold text-gray-500 bg-blue-100 rounded-t-md ">
                            <div class="flex w-9/12">
                                ...
                                <div class="w-5/12 text-left" >{{ __('Descripción') }}</div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center w-full space-x-1 text-sm text-gray-500 border-t-0 border-y hover:bg-gray-100 hover:cursor-pointer" wire:loading.class.delay="opacity-50" >
                            ...
                            {{-- @endif --}}
                                ...
                                <div class="w-5/12 ">{{ $presupuesto->descripcion }}</div>
                            ...
                            <div class="items-center flex-none w-3/12 md:flex">
                                ...
                                <div class="w-full space-x-2 text-center md:w-4/12">
                                    ...
                                    @endif --}}
                                    <x-icon.pdf-a class="w-4 text-red-500 hover:text-red-700" href="{{route('cliente.presupuesto.presupuestoPDF',$presupuesto)}}" target="_blank" title="PDF Presupuesto"/>
                                    {{-- @if(!Auth::user()->hasRole('Cliente'))
