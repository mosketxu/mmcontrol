            ...
            <div class="space-y-2">
                ...
                <div class="flex flex-col space-y-2 md:flex-row md:space-x-2 md:space-y-0">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="flex">
                            <input type="search" wire:model.live="filtroisbn" placeholder="Filtrar por ISBN/Cod.Producto..." class="w-full px-2 py-1 mb-1 text-xs border border-blue-100 rounded-md"/>
                            <input type="search" wire:model.live="filtroreferencia" placeholder="Filtrar Ref..." class="w-full px-2 py-1 mb-1 text-xs border border-blue-100 rounded-md"/>
                        </div>

                        <select wire:model.live="productoid" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
