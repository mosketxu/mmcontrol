<div class="">
    {{-- @livewire('menu',['entidad'=>$oferta],key($oferta->id)) --}}
                ...
                <div>
                    ...
                    <div>
                        ...
                        <div class="flex w-full space-x-2 text-sm text-gray-500 border-t-0 border-y " wire:loading.class.delay="opacity-50">
                            <div class="flex w-5 h-5 p-2 mr-2 font-medium text-center"><x-input.checkbox wire:model="selected" value="{{ $oferta->id }}" /></div>
                            <div class="flex-col w-1/12 my-2 text-left">{{ $oferta->id }}</div>
                            <div class="flex-col w-2/12 my-2 text-left">{{ $oferta->cliente->entidad }}</div>
                            <div class="flex-col w-1/12 my-2 text-left">{{ $oferta->ffecha }}</div>
                            <div class="flex-col w-2/12 my-2 text-left">{{ $oferta->contacto->entidad }}</div>
                            <div class="flex-col w-2/12 my-2 text-left">{{ $oferta->referencia }}</div>
