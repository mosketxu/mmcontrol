                ...
                <form wire:submit.prevent="save" class="text-sm">
                    <div class="p-2 m-2 space-y-2">
                        ...
                        <div class="flex flex-col mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                            ...
                            <div class="w-full form-item">
                                <x-jet-label for="importe">{{ __('Importe') }}</x-jet-label>
                                <input  wire:model.lazy="importe" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                disabled/>
                            </div>
                            <div class="w-full form-item">
                                <div class="w-full form-item">
