<div class="flex justify-between space-x-2 ">
    ...
    <div class="flex w-1/12 ">
        <div class="w-full">
            ...
            <div class="flex">
                <select wire:model.live="filtroidioma" class="w-full py-1 text-sm text-gray-600 bg-white border-blue-300 rounded-md shadow-sm appearance-none hover:border-gray-400 focus:outline-none">
                    <option value=""></option>
    ...
    <div class="flex w-1/12">
        <div class="w-full">
            ...
            <div class="flex">
                <select wire:model.live="filtrookexterno"
                    class="w-full py-1 text-sm text-gray-600 bg-white border-blue-300 rounded-md shadow-sm appearance-none hover:border-gray-400 focus:outline-none">
                    <option value="">-- selecciona --</option>
