...
<table width="100%" cellpadding="2" cellspacing="0" style="page-break-inside: avoid;">
    <tr>
        <td colspan="4" style="border-bottom:1px solid #94A3B8; padding-bottom:2px;"><span style="background-color:#F1F5F9; padding:2px 14px; border-radius:3px;"><strong>Datos Caja</strong></span></td>
    </tr>
