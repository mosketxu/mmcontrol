<a {{ $attributes->merge(['type' => 'button', 'class' => 'w-5 mr-2 transform hover:scale-125']) }}  title="Envios">
    <svg aria-hidden="true" focusable="false" class="w-5 h-5" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
