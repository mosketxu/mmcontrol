<form wire:submit.prevent="save" class="text-sm">
    ...
    <div class="p-2 m-2 ">
        <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
            <div class=" border border-red-300 rounded shadow-md p-2 ">
            ...
            <div class=" border border-green-300 rounded shadow-md p-2 ">
            ...
            <div class=" border border-yellow-300 rounded shadow-md p-2 ">
        ...
        <div class="flex flex-col mx-2 space-y-2 md:space-y-0 md:flex-row md:space-x-4">
            <div class="w-full form-item sm:w-2/12">
                ...
                <div wire:ignore>
                    <select class="form-control w-full" id="caja">
                        <option value="">Select Option</option>
