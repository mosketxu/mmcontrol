    ...
    <div class="p-1 m-2 ">
        ...
        <div class="flex flex-col mx-2 space-y-1 md:space-y-0 md:flex-row md:space-x-4">
            ...
            <div class="w-full form-item sm:w-2/12">
                <x-jet-label for="isbn">{{ __('Código') }}</x-jet-label>
                <input wire:model.lazy="producto.isbn" type="text" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50" required/>
            </div>
            {{-- titulo --}}
            <div class="w-full form-item sm:w-4/12">
                <x-jet-label for="referencia">{{ __('Referencia') }}</x-jet-label>
                <input wire:model.lazy="producto.referencia" type="text" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50" autofocus/>
            </div>
            {{-- cliente --}}
            <div class="w-full form-item sm:w-4/12">
            ...
            <div class="w-full form-item sm:w-1/12">
                ...
                <input  wire:model.lazy="producto.preciocoste" type="number" step="any" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
            </div>
            {{-- precio venta --}}
            <div class="w-full form-item sm:w-1/12">
                <x-jet-label for="precioventa">{{ __('€ Venta') }}</x-jet-label>
                <input  wire:model.lazy="producto.precioventa" type="number" step="any" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
            </div>
        </div>
    </div>
    <div class="p-2 m-2 ">
        <div class="grid grid-cols-1 gap-2 md:grid-cols-3">
            <div class="p-2 border border-red-300 rounded shadow-md ">
                <div class="p-1 rounded-md bg-red-50">
                    <h3 class="pl-1 font-semibold">Datos generales</h3>
                </div>
                {{-- formatos --}}
                ...
                <div class="flex flex-row space-x-4">
                    <div class="w-full form-item">
                        ...
                        <input  wire:model.lazy="producto.paginas" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
                    </div>
                    <div class="w-full form-item">
                        <x-jet-label for="tirada">{{ __('Tirada') }}</x-jet-label>
                        <input  wire:model.lazy="producto.tirada" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
                    </div>
                    <div class="form-item">
                ...
                <div class="flex flex-row">
                    ...
                    <div class="w-full form-item">
                        ...
                        <input  wire:model.lazy="producto.descripnovedad" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
                    </div>
                </div>
            </div>
            <div class="p-2 border border-green-300 rounded shadow-md ">
                ...
                <div class="flex flex-row space-x-4">
                    ...
                    <div class="w-full form-item">
                        ...
                        <input wire:model.lazy="producto.descripguardas" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
                    </div>
                </div>
                <div class="flex flex-row space-x-4">
                    <div class="form-item">
                    ...
                    <div class="w-full form-item">
                        ...
                        <input wire:model.lazy="producto.descripcd" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
                    </div>
                </div>
            </div>
            <div class="p-2 border border-yellow-300 rounded shadow-md ">
                ...
                <div class="flex flex-row space-x-4">
                    ...
                    <div class="w-full form-item">
                        ...
                        <input  wire:model.lazy="producto.descripsolapa" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex flex-col mx-2 space-y-2 md:space-y-0 md:flex-row md:space-x-4">
            ...
            <div class="w-full form-item sm:w-1/12 ">
                ...
                <input  wire:model.lazy="producto.udxcaja" type="number" class="w-full py-1 text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50"/>
            </div>
            <div class="w-full form-item sm:w-3/12">
                ...
                <input-error for="observaciones" class="w-full text-xs border-gray-300 rounded-md shadow-sm focus:border-orange-300 focus:ring focus:ring-orange-200 focus:ring-opacity-50" />
            </div>
            <div class="w-full form-item sm:w-3/12">
        ...
        <div class="p-2 m-2 ">
            <div class="flex flex-col mx-2 space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                <x-jet-button class="bg-orange-600">{{ __('Guardar') }}</x-jet-button>
