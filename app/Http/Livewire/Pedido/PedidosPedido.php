...
class PedidosPedido extends Component
{
    ...
    public function generarfactura(){
        ...
        $factura=Factura::create([
            ...
            'iva'=>round($this->pedido->preciototal * 0.21,2),
            'total'=>round($this->pedido->preciototal *1.21,2),
        ...
        FacturaDetalle::create([
            ...
            'iva'=>'0.21',
            'subtotalsiniva'=>round($this->pedido->precio * $this->pedido->tiradareal ,2),
            'subtotaliva'=>round($this->pedido->precio * $this->pedido->tiradareal * 0.21,2),
            'subtotal'=>round($this->pedido->precio * $this->pedido->tiradareal * 1.21,2),
            'concepto'=>$concepto,
            'orden'=>'0',
            'visible'=>'1',
        ]);
