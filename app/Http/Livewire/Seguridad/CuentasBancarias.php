...
class CuentasBancarias extends Component
{
    ...
    public function changeCampo(ModelsCuentaBancaria $valor,$campo,$valorcampo)
    {
        ...
        $p->$campo=$valorcampo;
        $p->save();
        $this->dispatch('notify', 'Cuenta Bancaria Actualizada.');
    }
    ...
    public function save()
    {
        ...
        $this->dispatch('notify', 'Cuenta Bancaria añadida con éxito');
    ...
    public function delete($valorId)
    {
        ...
        if ($borrar) {
            ...
            try {
                $borrar->delete();
                $this->dispatch('notify', 'Cuenta Bancaria eliminada!');
            } catch (QueryException $e) {
                $this->dispatch('notify', 'No se puede eliminar: hay clientes usando esta cuenta.');
            }
        }
    }
}
